...
public class CreatingLineGraph2a extends Canvas {
	private int x;
	private int y;
...
//axisRange should be multiple of axiaMargin
	public CreatingLineGraph2a(int x, int y,int xAxisStartRange,int xAxisEndRange,int yAxisStartRange,int yAxisEndRange) {
		this.x = x;
		this.y = y;
	...
	public static void main(String[] args) {
		CreatingLineGraph2a m = new CreatingLineGraph2a(200, 200,1960,2020,0,350);
