...
public class CreatingPieChart1 extends Canvas {
	private Map<String,Double> plottingPoints = new HashMap<String,Double>();

	public CreatingPieChart1(Map<String,Double> plottingPoints) {
	...
	public void paint(Graphics g) {
		...
		for(String key:keys) {
			...
			g.drawArc(200, 200, 100, 100, x.intValue(), z.intValue());
			 code = code+25;
			 if(key.equals("moto c")) {
				 g.setColor(Color.BLACK);
			 }else if(key.equals("moto g")) {
				 g.setColor(Color.BLUE);
			 }else if(key.equals("moto x")) {
